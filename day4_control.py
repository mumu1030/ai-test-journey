...
pass_cases = [case for case in test_cases if case['result']=="pass"] #遍历pass用例
fail_cases = [case for case in test_cases if case['result']=="fail"] #遍历fail用例
skip_cases = [case for case in test_cases if case['result']=="skip"] #遍历skip用例
fail_cases_P0 = [case for case in fail_cases if case['priority']=="P0"] #遍历 fail且为p0 用例
fail_cases_P1 = [case for case in fail_cases if case['priority']=="P1"] #遍历 fail且为p1 用例
